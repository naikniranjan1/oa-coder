...
export class WelcomeHeader extends LitElement {
        ...
        return html`
            <div class="container">
                ...
                <div class="header-section">
                    <div class="title">Welcome to OA Coder</div>
                    <div class="subtitle">Set up your AI model</div>
                </div>
                ...
                <div class="footer">
                    OA Coder does not collect your personal data —
    ...
    openPrivacyPolicy() {
        ...
        if (window.api?.common) {
            window.api.common.openExternal('https://oacoder.dev/privacy-policy');
        }
    }
}
