...
// const { createLLM } = require('../../common/ai/factory'); // Removed reference to factory.js
...
`;
        ...
        const basePrompt = getSystemPrompt('oa_coder_analysis', '', false);
...
Keep all points concise and build upon previous analysis if provided.`,
            ...
            // Analysis functionality temporarily disabled
            const completion = { content: 'Analysis not available - feature disabled' };
            ...
            for (const line of lines) {
                ...
                if (trimmedLine.startsWith('-') && currentSection === 'summary-overview') {
                    ...
                    if (summaryPoint && !structuredData.summary.includes(summaryPoint)) {
                        // Update existing summary (keep maximum 5 items)
