...
module.exports = {
  ...
  initialize() {
    ...
    // Enhanced for AI proctoring evasion: Advanced stealth settings
    ipcMain.handle('settings:get-advanced-stealth', async () => await settingsService.getAdvancedStealthSetting());
    ipcMain.handle('settings:set-advanced-stealth', async (event, isEnabled) => await settingsService.setAdvancedStealthSetting(isEnabled));
    ipcMain.handle('settings:set-custom-hotkeys', async (event, customHotkeys) => await settingsService.setCustomHotkeys(customHotkeys));
    ipcMain.handle('settings:get-custom-hotkeys', async () => await settingsService.getCustomHotkeys());
    ...
    ipcMain.handle('get-web-url', () => null); // Web removed
